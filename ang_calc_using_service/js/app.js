...
myApp.controller("myController", function($scope, calcService){
	...
	$scope.add = function(){
		if(isNaN(parseInt($scope.firstNum))===true|| isNaN(parseInt($scope.secondNum))===true){
			...
			$scope.result = calcService.add($scope.firstNum, $scope.secondNum);
		}
	};
	...
	$scope.subract = function(){
		if(isNaN(parseInt($scope.firstNum))===true|| isNaN(parseInt($scope.secondNum))===true){
			...
			//$scope.result = parseInt($scope.firstNum) - parseInt($scope.secondNum);
			$scope.result = calcService.subract($scope.firstNum, $scope.secondNum);
		}
	};
	...
	$scope.multiply = function(){
		if(isNaN(parseInt($scope.firstNum))===true|| isNaN(parseInt($scope.secondNum))===true){
			...
			//$scope.result = parseInt($scope.firstNum) * parseInt($scope.secondNum);
			$scope.result = calcService.multiply($scope.firstNum, $scope.secondNum);
		}
	};
	...
	$scope.divide = function(){
		if(isNaN(parseInt($scope.firstNum))===true|| isNaN(parseInt($scope.secondNum))===true){
			...
			{
				//$scope.result = parseInt($scope.firstNum) / parseInt($scope.secondNum);
				$scope.result = calcService.divide($scope.firstNum, $scope.secondNum);
			}
		}
